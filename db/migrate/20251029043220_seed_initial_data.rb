class SeedInitialData < ActiveRecord::Migration[7.1]
  def up
    ...
    user.update!(
      ...
      role: "user"  # role admin sẽ tự gán khi login bằng Google nếu trùng ADMIN_EMAIL
    )
    ...
    puts "✅ Seed completed: User, Categories, FoodDrinks, Orders, OrderItems, Ratings"
    puts "✅ Admin role sẽ được gán khi login Google nếu email trùng ENV['ADMIN_EMAIL']"
  end
